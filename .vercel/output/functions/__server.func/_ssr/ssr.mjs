...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-u7Dg4vKv.mjs");
...
var manifest = {
	"68155b852f651cbb5e4fc5e23d5c9d45dd8645758aa80bc18b9f32a6ecd1e8d0": {
		functionName: "judgeMoments_createServerFn_handler",
		importer: () => import("./identify-9V4ExA-c.mjs")
	},
	"7d305bc4556981cf000308f16c62017b5c56759c3c248ed266b93ba25d5e79bb": {
		functionName: "transcribeClip_createServerFn_handler",
		importer: () => import("./karaoke-CpRu-ZU-.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DXP4cm9C.mjs").then((n) => n.t),
